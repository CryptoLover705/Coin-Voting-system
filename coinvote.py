# backend script to interface with sct-api-wrapper and the SCT network to track supplied ID's and determine coin voting %
...
# connect to the SCT network via the api-wrapper, announce the ID's being watched..

print('COINVOTE python script')
print("ID's being tracked:", ID)

w = q.SCT()		# instantiate the grpc connection via the wrapper
